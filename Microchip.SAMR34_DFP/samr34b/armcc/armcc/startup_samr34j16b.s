;/*****************************************************************************
; * \file     startup_samr34j16b.s
; * \brief    ARMCC startup file for ATSAML21J18B
; *
; * \note
...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     NVMCTRL_Handler           ; 4  Non-Volatile Memory Controller Handler
                DCD     DMAC_Handler              ; 5  Direct Memory Access Controller Handler
                DCD     USB_Handler               ; 6  Universal Serial Bus Handler
                DCD     EVSYS_Handler             ; 7  Event System Interface Handler
                DCD     SERCOM0_Handler           ; 8  Serial Communication Interface Handler
                DCD     SERCOM1_Handler           ; 9  Serial Communication Interface Handler
                DCD     SERCOM2_Handler           ; 10 Serial Communication Interface Handler
                DCD     SERCOM3_Handler           ; 11 Serial Communication Interface Handler
                DCD     SERCOM4_Handler           ; 12 Serial Communication Interface Handler
                DCD     SERCOM5_Handler           ; 13 Serial Communication Interface Handler
                ...
                DCD     ADC_Handler               ; 22 Analog Digital Converter Handler
                DCD     AC_Handler                ; 23 Analog Comparators Handler
                DCD     DAC_Handler               ; 24 Digital-to-Analog Converter Handler
                DCD     PTC_Handler               ; 25 Peripheral Touch Controller Handler
                DCD     AES_Handler               ; 26 Advanced Encryption Standard Handler
                DCD     TRNG_Handler              ; 27 True Random Generator Handler
__Vectors_End
