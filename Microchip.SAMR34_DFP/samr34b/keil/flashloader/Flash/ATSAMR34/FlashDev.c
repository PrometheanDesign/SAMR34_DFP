 ...
 * $Revision:    V1.01
 *
 * Project:      Flash Device Description for ATSAMR34
 * --------------------------------------------------------------------------- */

/* History:
 *  Version 1.01
 *    increased Programming Page Size
...
struct FlashDevice const FlashDevice  =  {
   ...
   "ATSAMR34 32kB Flash",       // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 64kB Flash",       // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 128kB Flash",      // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 256kB Flash",      // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 1kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 2kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 4kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMR34 8kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
