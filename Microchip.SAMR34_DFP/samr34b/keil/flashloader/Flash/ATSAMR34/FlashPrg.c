 ...
 * $Revision:    V1.01
 *
 * Project:      Flash Programming Functions for ATSAMR34
 * --------------------------------------------------------------------------- */

/* History:
 *  Version 1.01
 *    improved program page function
...
/* ---- SAM D20 ------------------------------------------------------------------*/
#if defined ATSAMR34_256 || defined ATSAMR34_128 || defined ATSAMR34_64 || defined ATSAMR34_32
  #define PAC_BASE             0x40000000
  #define NVMCTRL_BASE         0x41004000        /* SAMR34                     */
#endif

#if defined ATSAMR34_256
  #define FLASH_SIZE           0x40000
#endif

#if defined ATSAMR34_128
  #define FLASH_SIZE           0x20000
#endif

#if defined ATSAMR34_64
  #define FLASH_SIZE           0x10000
#endif

#if defined ATSAMR34_32
