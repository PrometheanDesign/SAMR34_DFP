 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for SAMR34J17B
 *
...
const DeviceVectors exception_table=
{
        ...
        /* .pfnSERCOM0_Handler      = */ (void*) SERCOM0_Handler,     /* 8  Serial Communication Interface */
        /* .pfnSERCOM1_Handler      = */ (void*) SERCOM1_Handler,     /* 9  Serial Communication Interface */
        /* .pfnSERCOM2_Handler      = */ (void*) SERCOM2_Handler,     /* 10 Serial Communication Interface */
        /* .pfnSERCOM3_Handler      = */ (void*) SERCOM3_Handler,     /* 11 Serial Communication Interface */
        /* .pfnSERCOM4_Handler      = */ (void*) SERCOM4_Handler,     /* 12 Serial Communication Interface */
        /* .pfnSERCOM5_Handler      = */ (void*) SERCOM5_Handler,     /* 13 Serial Communication Interface */
...
#else /* Legacy defined(_SAML21J17B_H) */
